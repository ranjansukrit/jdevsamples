...
(function() {
    var provider = app.data.ranjan1 = new Everlive({
            offlineStorage: true,
            appId: 'gsdcgidndquozk94',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'ranjan1_access_token',
...
// START_CUSTOM_CODE_ranjan1
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_ranjan1